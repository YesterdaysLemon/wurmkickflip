...
4. [`evolution-lab.md`](evolution-lab.md) — current evolution strategy and future contact-rich research.
5. [`policy-contract.md`](policy-contract.md) — canonical mounted-stunt and detached-locomotion contracts.
6. [`replay-artifacts.md`](replay-artifacts.md) — checksummed replay schema and playback rules.
7. [`asset-roadmap.md`](asset-roadmap.md) — primitive assets and future art needs.
8. [`agent-handoff.md`](agent-handoff.md) — change rules and verification checklist.
9. [`backlog.md`](backlog.md) — remaining work and completed milestones.
